...
def exe(cmd):
    ...
    if(cmd[0] == 'N'):
        ...
        print("No propper command recieved!");
...
for i in range(len(allcmd)):
    exe(allcmd[i])
    print("newpos: ",x,", ",y," med ", wx," og ",wy)


print("When done, we are at dist: ", manhat_dist())
